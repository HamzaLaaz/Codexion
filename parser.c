...
/*   Updated: 2026/07/30 05:36:43 by hlaaz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static long	ft_atol(const char *str)
{
	...
	result = 0;
	i = 0;
	//todo don't forget handell overflow
	if (!str || !str[0])
		return (-1);
	while (str[i])
	{
